                        ...
                        <div class="sidebar sidebar-product">
                            <div class="widget widget-products">
                                ...
                                <div class="products">
                                    <div class="product product-sm">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{asset('assets/frontend/')}}/assets/images/products/single/sidebar/1.jpg" alt="Product image" class="product-image">
                                            </a>
                                        </figure>
                                    ...
                                    <div class="product product-sm">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{asset('assets/frontend/')}}/assets/images/products/single/sidebar/2.jpg" alt="Product image" class="product-image">
                                            </a>
                                        </figure>
                                    ...
                                    <div class="product product-sm">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{asset('assets/frontend/')}}/assets/images/products/single/sidebar/3.jpg" alt="Product image" class="product-image">
                                            </a>
                                        </figure>
                                    ...
                                    <div class="product product-sm">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{asset('assets/frontend/')}}/assets/images/products/single/sidebar/4.jpg" alt="Product image" class="product-image">
                                            </a>
                                        </figure>
                            ...
                            <div class="widget widget-banner-sidebar">
                                ...
                                <div class="banner-sidebar banner-overlay">
                                    <a href="#">
                                        <img src="{{asset('assets/frontend/')}}/assets/images/blog/sidebar/banner.jpg" alt="banner">
                                    </a>
                                </div><!-- End .banner-ad -->
                            </div><!-- End .widget -->
