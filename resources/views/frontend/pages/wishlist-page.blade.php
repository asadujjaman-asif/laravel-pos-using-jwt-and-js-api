                    ...
                    <td class="product-col">
                        <div class="product">
                            <figure class="product-media">
                                <a href="#">
                                    <img src="{{asset('assets/frontend/')}}//assets/images/products/table/product-1.jpg" alt="Product image">
                                </a>
                            </figure>
                ...
                <tr>
                    <td class="product-col">
                        <div class="product">
                            <figure class="product-media">
                                <a href="#">
                                    <img src="{{asset('assets/frontend/')}}/assets/images/products/table/product-2.jpg" alt="Product image">
                                </a>
                            </figure>
                ...
                <tr>
                    <td class="product-col">
                        <div class="product">
                            <figure class="product-media">
                                <a href="#">
                                    <img src="{{asset('assets/frontend/')}}/assets/images/products/table/product-3.jpg" alt="Product image">
                                </a>
                            </figure>
